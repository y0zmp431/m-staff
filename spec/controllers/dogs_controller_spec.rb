  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dog as @dog" do
        ...
        post :create, {:dog => { "url" => "invalid value" }}, valid_session
        assigns(:dog).should be_a_new(Dog)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dog" do
        ...
        Dog.any_instance.should_receive(:update_attributes).with({ "url" => "MyString" })
        put :update, {:id => dog.to_param, :dog => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dog as @dog" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dog.any_instance.stub(:save).and_return(false)
        put :update, {:id => dog.to_param, :dog => { "url" => "invalid value" }}, valid_session
        assigns(:dog).should eq(dog)
      end
