...
Функционал: Собственно собаки
  ...
  Сценарий: Одной фотографии может соответствовать несколько песиков
      ...
      И существует собака "Тоши"
			И я перехожу на страницу собаки "Номка"
    Если я кликаю ссылку "Добавить фото"
      #И я ввожу "Тоши" в поле "dog_name" 
  ...
  Сценарий: Абы-кто не видит ссылки, что бы добавлять собак
    Если я перехожу на страницу Список собак
    То на странице не должно быть текста "Добавить"

  Сценарий: Абы-кто не может добавлять собак
    Если я перехожу на страницу "Новый песик"
		То  я должен увидеть сообщение "Нет привелегий для выполнения данного действия"
    
  Сценарий: Скрытую собаку не видно в списке
    Допустим существует скрытая собака "Тоши"
      И существует собака "Номка"
    Если я перехожу на страницу Список собак
    То я должен увидеть текст "Номка"
      И на странице не должно быть текста "Тоши"

  Сценарий: Скрытых собак может видеть писатель в списке скрытых собак
    Допустим я писатель
      И существует скрытая собака "Тоши"
      И существует собака "Номка"
    Если я перехожу на страницу Список собак
      И кликаю ссылку "Скрытые собаки"
    То я должен увидеть текст "Тоши"
      И я должен увидеть текст "Открытый список собак"
      И на странице не должно быть текста "Номка"
  


  Сценарий: Каждый песик должен иметь аватарку
		Допустим я писатель
      И существует собака "Номка"
			И я перехожу на страницу собаки "Номка"
    Если я кликаю ссылку "Редактировать"
			И я выбираю файл "test/factories/nomka.JPG" в поле "dog[avatar]"
			И кликаю кнопку "Сохранить"
    То у собаки "Номка" должна быть аватарка
  ...
  Сценарий: Под заголовком — именем собаки пишется ее возраст и титул
    ...
    #Допустим существует статья "Тонский и Номский на прогулке"
    #  И существует собака "Номка"
    #  И существует собака "Тоши"
